...
CREATE TABLE public.blacklisted (
    id integer NOT NULL,
    nric character varying(12) NOT NULL,
    aims character varying(1),
    liam character varying(1)
);
...
7	SYSTEM	2019-11-29 04:15:51.831	Azizah Hamidi	850211-08-2656	100.00	D	27
...
8	SYSTEM	2020-01-02 06:35:36.569	27	1992-05-25 00:00:00	hamidi@gmail.com	Hamidi	F	175.00	Zahid	MY	850211-08-2656		M	65.00	27
\.
...
SYSTEM	2020-01-03 03:19:51.058	30	1990-01-03 00:00:00	hamidi@gmail.com	Hamidi	F	175.00	Zahid	MY	850211-08-2656		M	65.00	27
\.
...
ALTER TABLE ONLY public.blacklisted
    ADD CONSTRAINT blacklisted_nric_key UNIQUE (nric);
...
ALTER TABLE ONLY public.blacklisted
    ADD CONSTRAINT blacklisted_pkey PRIMARY KEY (id);
